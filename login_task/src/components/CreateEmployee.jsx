...
const CreateEmployee = () => {
  ...
  const validateForm = () => {
    ...
    if (!employee.f_Designation) formErrors.f_Designation = 'Designation is required';
  ...
  return (
    <div className="create-employee-container">
      ...
      <form onSubmit={handleSubmit}>
        <label>
          Name:
          <input type="text" name="f_Name" value={employee.f_Name} onChange={handleChange} required />
          {errors.f_Name && <span>{errors.f_Name}</span>}
        </label>

        <label>
          Email:
          <input type="email" name="f_Email" value={employee.f_Email} onChange={handleChange} required />
          {errors.f_Email && <span>{errors.f_Email}</span>}
        </label>

        <label>
          Mobile No:
          <input type="text" name="f_Mobile" value={employee.f_Mobile} onChange={handleChange} required />
          {errors.f_Mobile && <span>{errors.f_Mobile}</span>}
        </label>

        <label>
          Designation:
          <input type="text" name="f_Designation" value={employee.f_Designation} onChange={handleChange} required />
          {errors.f_Designation && <span>{errors.f_Designation}</span>}
        </label>

        <label>
          Gender:
          <select name="f_gender" value={employee.f_gender} onChange={handleChange} required>
        ...
        <label>
          Course:
          <input type="text" name="f_Course" value={employee.f_Course} onChange={handleChange} required />
